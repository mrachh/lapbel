     ...
     1       srcvals,srccoefs,ifplot,fname)
      ...
      do i=1,npts
        ...
        call cross_prod3d(dl,wtmp,rhs(1,i))
        cfree(1:3,i) = 0
        dfree(1:3,i) = 0
        vharm(1:3,i) = 0
      enddo
...
C$       t2 = omp_get_wtime() 
     ...
     1  srcvals,vharm_cross,vharm_cross_div)
      ...
      open(unit=33,file='stell-hodge/res_summary.dat',access='append')
      write(33,'(2x,i1,2x,i1,2x,i7,2(2x,i3),3(2x,e11.5))') irep,norder,
     1   npts,niter(1),niter(2),t2-t1,err1,err2
      close(33)
      
      dirname = 'stell-hodge/'
      write(fname_rhs,'(a,a,i2.2,a,i2.2,a,i1,a)') trim(dirname),
     1   'rhs_',ipars(1),'_',ipars(2),'_norder',norder,'.dat'
      open(unit=78,file=trim(fname_rhs),form='unformatted')
      write(78) rhs
      close(78)
      
      write(fname_vharm,'(a,a,i2.2,a,i2.2,a,i1,a,i1,a)') trim(dirname),
     1   'hvec_',ipars(1),'_',ipars(2),'_norder',norder,'_irep',irep,
     2   '.dat'

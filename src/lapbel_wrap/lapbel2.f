...
c
      ...
      subroutine getnearquad_lap_bel2(npatches,norders,
...
c
c
      subroutine lpcomp_lap_bel2(npatches,norders,ixyzs,
...
c
      call lpcomp_lap_bel_addsub2(npatches,norders,ixyzs,
...
c
c
      subroutine lpcomp_lap_bel_addsub2(npatches,norders,ixyzs,
     1   iptype,npts,srccoefs,srcvals,
...
c
c        
      subroutine lap_bel_solver2(npatches,norders,ixyzs,
...
c
     ...
     3  rhs,novers,npts_over,ixyzso,srcover,wover,rhs2)
      ...
      ra = 0
      do i=1,npts
        erra = erra + (rhs(i)/5.0d0-rhs2(i))**2
        ra = ra + rhs2(i)**2
      enddo
      erra = sqrt(erra/ra)
      call prin2('error in rhs=*',erra,1)
